...
const supabaseURL = 'https://cretgoepjeylwkaevzbd.supabase.co';
const api_key = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNyZXRnb2VwamV5bHdrYWV2emJkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjIzNTA4NzEsImV4cCI6MjA3NzkyNjg3MX0.Dif9ZiY5OLlQTP91JMeREoVD-Mj821SsO9dhIC_06ls';
...
//         alert('Data inserted sccesffulyy');
//     }
// }

// document.getElementById('submit').addEventListener('click', insertRow);
